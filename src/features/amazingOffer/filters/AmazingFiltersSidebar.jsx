...
import AmazingPriceFilter from "./AmazingPriceFilter";
import AmazingSortBar from "../sorting/AmazingSortBar";
...
export default function AmazingFiltersSidebar({ filters, setFilters }) {
    ...
    <div className="h-full flex flex-col text-sm">
      ...
      <div className="flex-1 overflow-y-auto pr-2">
        ...
        <Section id="sort" title="مرتب‌سازی" open={open} setOpen={setOpen}>
          <AmazingSortBar filters={filters} setFilters={setFilters} />
        </Section>
        ...
        <Section id="price" title="محدوده قیمت" open={open} setOpen={setOpen}>
          <AmazingPriceFilter filters={filters} setFilters={setFilters} />
        </Section>

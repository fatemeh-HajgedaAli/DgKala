...
export default function AmazingAction({ product }) {
  return (
    ...
    >
      ...
      <button className="w-full bg-red-500 hover:bg-red-600 text-white font-bold py-3 rounded-xl transition duration-200 text-sm shadow-md shadow-red-100 mt-2">
        افزودن به سبد خرید
      </button>
    </div>
  );

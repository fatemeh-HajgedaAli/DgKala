...
export default function CartItem({ item, onIncrease, onDecrease, onRemove }) {
  ...
  return (
    <div
      dir="rtl"
      className="flex justify-between gap-6 p-6  last:border-0 bg-white w-full"
    >
      {/* بخش تصویر محصول */}
      ...
      <div className="flex-1 flex flex-col justify-between min-h-[140px]">
        ...
        {/* دکمه‌های پایین: شمارنده در راست و بعدا می‌خرم در چپ با هماهنگی کامل */}
        <div className="flex justify-end items-center w-full gap-8">
          {/*  (سمت چپ) */}
          <button className="text-xs font-bold text-gray-600 border border-gray-200 rounded-xl px-6 py-3 hover:bg-gray-50 transition">
            بعدا می‌خرم
          </button>
          {/* counter */}
